...
<p style="font-size:12px;font-weight:700;letter-spacing:.06em;text-transform:uppercase;color:#e94560;margin:0 0 8px;">New member</p>
<h1 style="font-size:20px;margin:0 0 4px;">{{ $newMember->name }} joined {{ $organization->name }}</h1>
<p style="font-size:13px;color:#5b5b6b;margin:0;">They accepted your invite and are now a member.</p>
</td></tr>
<tr><td style="padding:20px 28px;text-align:center;">
<a href="{{ $membersUrl }}" style="display:inline-block;background:#1a1a2e;color:#ffffff;font-size:13px;font-weight:700;text-decoration:none;padding:12px 24px;border-radius:10px;">Manage members</a>
</td></tr>
</table>
</td></tr>
</table>
