...
class PublicOrgPageTest extends TestCase
{
    ...
    public function test_public_org_page_shows_branding_and_splits_events_into_upcoming_and_past(): void
    {
        ...
        Event::create(['title' => 'Upcoming Meetup', 'status' => 'approved', 'is_private' => false, 'date' => now()->addWeek()->toDateString(), 'slug' => 'upcoming-meetup', 'organizer_id' => $owner->id, 'organization_id' => $org->id]);
        Event::create(['title' => 'Past Meetup', 'status' => 'approved', 'is_private' => false, 'date' => now()->subWeek()->toDateString(), 'slug' => 'past-meetup', 'organizer_id' => $owner->id, 'organization_id' => $org->id]);
        Event::create(['title' => 'Pending Meetup', 'status' => 'pending', 'is_private' => false, 'date' => now()->addWeek()->toDateString(), 'slug' => 'pending-meetup', 'organizer_id' => $owner->id, 'organization_id' => $org->id]);
        Event::create(['title' => 'Private Meetup', 'status' => 'approved', 'is_private' => true, 'date' => now()->addWeek()->toDateString(), 'slug' => 'private-meetup', 'organizer_id' => $owner->id, 'organization_id' => $org->id]);
    ...
    public function test_directory_only_lists_organizations_with_a_real_public_event(): void
    {
        ...
        Event::create(['title' => 'Upcoming', 'status' => 'approved', 'is_private' => false, 'date' => now()->addWeek()->toDateString(), 'slug' => 'upcoming', 'organizer_id' => $owner->id, 'organization_id' => $active->id]);
        Event::create(['title' => 'Private', 'status' => 'approved', 'is_private' => true, 'date' => now()->addWeek()->toDateString(), 'slug' => 'private', 'organizer_id' => $owner->id, 'organization_id' => $privateOnly->id]);
