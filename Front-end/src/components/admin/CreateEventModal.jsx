            ...
            <div>
              ...
              {form.pricing === 'paid' && (
                <div className="mt-3 space-y-2">
                  <Input label="Price (₱)" value={form.price} onChange={e => up('price', e.target.value)} type="number" icon={DollarSign} placeholder="500" />
                  <p className="text-[11px] text-slate-400">Payment happens outside QRMeets - post where to pay in your event description or your own channels. Attendees submit proof of payment when they register.</p>
                </div>
              )}
            </div>
